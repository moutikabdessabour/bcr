...
[![](https://img.shields.io/badge/dev%20-`r desc::desc_get_version()`-brightgreen.svg)](https://github.com/moutikabdessabour/bcr)
...
*bcr* is an `R` package that scraps the web (mainly [**Le Boursier**](https://leboursier.ma)) for Moroccan Financial Data. It aims to facilitate the access of this data on `R`.
...
```
## Documentation
A minimal documentation is provided [here](https://moutikabdessabour.github.io/bcr/reference/index.html).
